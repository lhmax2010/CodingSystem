...
**版本**: v0.9 Draft（v0.8 三方复审 1 GO / 2 NO-GO 后修订版，待第九轮复审）
**状态**: 复审中
**读者**: 框架开发（Codex）、cross-reviewer（Kimi / Codex / Claude Code）、后续业务 Agent 开发者
**关联文档**: 01_Contract_Spec、02–06_Agent_Design_Guide、07_Conformance_and_Onboarding、08_Codex_Dev_Guide、09_Phased_Dev_Plan、docs/review/HLD_v0.1–v0.8_review_disposition.md（v0.8 处置表为本版逐条依据）
...
- A3 引用：01/07/08/09（待产出）；docs/review/ 下 v0.1–v0.8 八轮处置表。
