...
Compiler Agent 严格遵守 Agent Team Contract v0.7.3。具体包括：
...
对齐 Team Contract v0.7.3 4.2，含新增的 `token_usage` 顶层字段和 `evidence_packet_ref` event 字段。
