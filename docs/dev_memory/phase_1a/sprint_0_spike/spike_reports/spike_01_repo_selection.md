...
- 至少 3 个开发者熟悉该 repo，便于后续 dogfooding
...
| 3+ familiar developers | needs PM/team confirmation | public history has 67 authors, but dogfooding familiarity must be confirmed by user/team |

S0-01 is selected and ready for user/team confirmation on the human familiarity criterion.
...
1. User/team confirms whether at least 3 developers are familiar enough with `pkgmgr-info` for dogfooding.
2. After confirmation, proceed to S0-02: compile_commands.json generation validation on the selected repo.
