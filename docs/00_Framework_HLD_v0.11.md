...
**关联文档**: 01_Contract_Spec、02–06_Agent_Design_Guide、07_Conformance_and_Onboarding、08_Codex_Dev_Guide、09_Phased_Dev_Plan、docs/review/HLD_v0.1–v0.10_review_disposition.md（v0.10 处置表为本版逐条依据）
...
- A3 引用：01/07/08/09（待产出）；docs/review/ 下 v0.1–v0.10 十轮处置表。
